...
const Card = ({ cardData, userId }) => {
	...
	return (
		...
		>
			...
			<div className="card-body row px-3 py-2 gap-3">
				<div className="col align-items-center py-md-0 py-2">
					<h6 className="col fw-bold py-0 py-0 mb-1">
						<span>
							{cardData.course} {cardData.course_title}
							{cardData.name != "" ? " - " + cardData.name : ""}
						</span>
					</h6>
					<div className="row col-sm m-0 gap-1 pt-0">
						<h6 className="small col-lg-auto col-auto my-auto  bg-body-secondary align-content-center px-3 py-1 rounded-1 border">
